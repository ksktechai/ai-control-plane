...
public final class CorrelationIdHolder {
    ...
    /** Gets the correlation ID from the thread context. Returns null if not set. */
    public static String get() {
        return ThreadContext.get(CORRELATION_ID_KEY);
    }

    /**
     * Generates a new correlation ID and sets it in the thread context. Returns the generated ID.
     */
