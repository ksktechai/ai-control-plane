...
class VerificationResultTest {
    ...
    void shouldCreateValidVerificationResult() {
        List<Claim> claims = List.of(
            new Claim("AI is a technology", true, "chunk-1")
        );
    ...
    void shouldReturnImmutableClaims() {
        ...
        assertThatThrownBy(() -> result.claims().add(
            new Claim("Another claim", true, "chunk-2")
    ...
    void shouldImplementEqualsCorrectly() {
        ...
        VerificationResult v1 = new VerificationResult(
            VerificationStatus.GROUNDED, claims, 0.95, "reasoning"
        );
        VerificationResult v2 = new VerificationResult(
            VerificationStatus.GROUNDED, claims, 0.95, "reasoning"
        );
        VerificationResult v3 = new VerificationResult(
            VerificationStatus.UNGROUNDED, claims, 0.95, "reasoning"
        );
        VerificationResult v4 = new VerificationResult(
            VerificationStatus.GROUNDED, differentClaims, 0.95, "reasoning"
        );
        VerificationResult v5 = new VerificationResult(
            VerificationStatus.GROUNDED, claims, 0.85, "reasoning"
        );
        VerificationResult v6 = new VerificationResult(
