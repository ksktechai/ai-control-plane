...
class OllamaGenerateResponseTest {
    ...
    void shouldCreateValidResponse() {
        OllamaGenerateResponse response =
                new OllamaGenerateResponse("llama3.1:8b", "AI is artificial intelligence", true);
...
class OllamaModelListResponseTest {
    ...
    void shouldCreateResponseWithModels() {
        OllamaModelListResponse.OllamaModelInfo model1 =
                new OllamaModelListResponse.OllamaModelInfo(
                        "llama3.1:8b", "llama3.1:8b", 4700000000L);
        OllamaModelListResponse.OllamaModelInfo model2 =
                new OllamaModelListResponse.OllamaModelInfo(
                        "qwen2.5:7b", "qwen2.5:7b", 4100000000L);
    ...
    void shouldAccessModelInfoProperties() {
        OllamaModelListResponse.OllamaModelInfo modelInfo =
                new OllamaModelListResponse.OllamaModelInfo(
                        "mistral:7b", "mistral:7b", 7000000000L);
