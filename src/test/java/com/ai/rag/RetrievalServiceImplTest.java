...
class RetrievalServiceImplTest {
    ...
    void shouldRetrieveRelevantChunks() {
        Embedding queryEmbedding = new Embedding(new float[]{0.1f, 0.2f, 0.3f}, "nomic-embed-text");
    ...
    void shouldRetrieveWithExhaustiveStrategy() {
        ...
        RetrievalResult result = retrievalService.retrieve("What is AI?", RetrievalStrategy.EXHAUSTIVE);
